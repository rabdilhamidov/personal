 ...
 * @ORM\Entity(repositoryClass="Demos\BlogBundle\Entity\Repository\CategoryRepository")
 */
class Category
{
    /**
     ...
     * Add children
     *
     * @param \Demos\BlogBundle\Entity\Category $children
     * @return Category
     */
    public function addChild(\Demos\BlogBundle\Entity\Category $children)
    {
     ...
     * @param \Demos\BlogBundle\Entity\Category $children
     */
    public function removeChild(\Demos\BlogBundle\Entity\Category $children)
    {
